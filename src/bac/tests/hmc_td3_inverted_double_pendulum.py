...
test.hmc_baselines("td3_inverted_double_pendulum", InvertedDoublePendulum, TD3, 20_000)
test.hmc_ablation("td3_inverted_double_pendulum", InvertedDoublePendulum, TD3, 20_000)