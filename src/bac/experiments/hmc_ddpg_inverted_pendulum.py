...
prod.hmc_baselines("ddpg_inverted_pendulum_101", InvertedPendulum, DDPG, 1_000_000)
prod.hmc_ablation("ddpg_inverted_pendulum_101", InvertedPendulum, DDPG, 1_000_000)