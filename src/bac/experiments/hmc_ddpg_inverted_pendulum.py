...
def main():
    ...
    prod.hmc_baselines(f"ddpg_inverted_pendulum_{seed}", InvertedPendulum, DDPG, 1_000_000)
    prod.hmc_ablation(f"ddpg_inverted_pendulum_{seed}", InvertedPendulum, DDPG, 1_000_000)
