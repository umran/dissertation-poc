...
prod.hmc_baselines("ddpg_inverted_double_pendulum_102", InvertedDoublePendulum, DDPG, 1_000_000)
prod.hmc_ablation("ddpg_inverted_double_pendulum_102", InvertedDoublePendulum, DDPG, 1_000_000)