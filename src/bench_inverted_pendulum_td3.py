...
def bench_inverted_pendulum_td3():
    random_ddpg = VanillaActorCritic(InvertedPendulum(), TD3(InvertedPendulum()))
    ...
    vanilla_ddpg = VanillaActorCritic(InvertedPendulum(), TD3(InvertedPendulum()))
    ...
    hybrid_hmc = HybridHMC(InvertedPendulum(), TD3(InvertedPendulum()))
